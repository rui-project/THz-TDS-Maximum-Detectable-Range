...
load('Metallized_Pingpong_@120cm.mat')
...
xlabel('Time[ps]')
ylabel('Amplitude')
legend('Cross-talk','Metallized Ping-pong ball Reflection @ 120cm distance')
...
xlabel('Frequency[THz]')
ylabel('Norm. Magn.[dB]')
legend('Metallized Pingpong @ 120cm','Reference @ 120cm')
...
distance = 1.2;
[RMax_Sphere_1m,RPower_Sphere_1m] = Metallized_Pingpong_Cal_distance(Power_ref_locs, Power_ref_pks, distance, AMP_120cm_DR_Sphere);   % THz
xlim([0 1.6]);
grid on
xlabel('Frequency[THz]')
ylabel('Magn.[dB]')
legend('Metallized Pingpong Reflection @ 120cm distance','Theoretical Maximum @ 120cm distance')
